...
export const TOOLS_DEFINITIONS = [
  ...
  },
  {
    ...
    function: {
      ...
      description: 'Search internal knowledge base Markdown files for a query string.',
      parameters: {
        type: 'object',
        properties: {
  ...
  },
  {
    ...
    function: {
      name: 'run_command',
      description: 'Execute an allowed command in the workspace.',
      parameters: {
        type: 'object',
        properties: {
...
export const toolsSchema = TOOLS_DEFINITIONS;
export const TOOL_DEFINITIONS = TOOLS_DEFINITIONS;
