...
echo "=== [1/3] Writing Reverse Proxy Server (server.py) ==="
...
echo "=== [2/3] Restarting Gateway Process ==="
...
echo "Waiting 4 seconds for proxy startup..."
sleep 4
...
echo -e "\n3. Testing Reverse Proxy Pass-Through Endpoint (/):"
curl -s -I http://localhost:3456/ | head -n 5

echo -e "\nProxy active under PID $SERVER_PID. Logs writing to server.log."
