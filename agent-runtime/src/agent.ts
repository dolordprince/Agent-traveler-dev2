...
When building or testing a web application:
1. Build/install the application using run_command.
2. Start it with browser_start_app (specify command, directory, port).
3. Navigate to it with browser_navigate (e.g. http://localhost:<port>).
4. Check browser_get_page_state for title and visible content.
5. Interact using browser_click, browser_fill, browser_wait_for.
6. Check browser_get_console for JS errors, page errors, network failures.
7. If errors exist: inspect source files, repair, rebuild, browser_stop_app, browser_start_app, repeat.
8. Capture browser_screenshot for final visual verification.
9. browser_stop_app when done.
