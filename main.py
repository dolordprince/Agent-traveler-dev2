...
app = FastAPI(
    ...
    description="OpenAI Compatible Gateway routed via OpenRouter free tier.",
    version="1.4.0"
)
...
async def chat_completions(req: OpenAICompletionRequest):
    ...
    # Force free router if a paid model name is passed without account credits
    if not req.model.endswith(":free") and req.model != "openrouter/free":
